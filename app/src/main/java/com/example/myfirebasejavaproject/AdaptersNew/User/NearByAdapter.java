...
public class NearByAdapter extends RecyclerView.Adapter<NearByAdapter.MVViewHolder> {

    List<UserHelperClass> mostviewLocations;
    Context mContext;
    String uid;

    public NearByAdapter(List<UserHelperClass> mostviewLocations, Context context) {
    ...
    @NonNull
    @Override
    public NearByAdapter.MVViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.most_viewed_card_design, parent, false);
        NearByAdapter.MVViewHolder nearByHolder = new NearByAdapter.MVViewHolder(view);
        return nearByHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull NearByAdapter.MVViewHolder holder, int position) {
