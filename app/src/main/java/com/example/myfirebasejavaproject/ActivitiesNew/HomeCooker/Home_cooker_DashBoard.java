...
import com.example.myfirebasejavaproject.AdaptersNew.HomeCooker.dialogsAdapter.DialogAddMainFoodAdapter;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (id) {
            ...
            case R.id.nav_bookings:
                startActivity(new Intent(Home_cooker_DashBoard.this, HomeCookerBookings.class));
            default:
                return true;
        }
