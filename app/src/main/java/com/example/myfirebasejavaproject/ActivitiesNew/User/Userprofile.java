...
public class Userprofile extends AppCompatActivity {
    ...
    TextInputLayout fullnaeme, email, password, phonenum,address;
    TextView fullNameLabel, usernameLabel;

    String _USERNAME, _EMAIL, _PASSWORD, _PHONENO, _NAME,_ADDRESS;
...
//                password.getEditText().setText(_PASSWORD);
    ...
    private void checkData(){
        ...
        if(!name.equals(_NAME) || !emaill.equals(_EMAIL) || !phone.equals(_PHONENO)  || !pass.equals(_PASSWORD) || !add.equals(_ADDRESS))
        {
            ...
            refrence.child("address").setValue(add);
...
//        }
    ...
    private boolean isAddressChanged() {
        ...
        if (!_ADDRESS.equals(address.getEditText().getText().toString())) {
            refrence.child(_ADDRESS).child("address").setValue(address.getEditText().getText().toString());
